              ...
              <div class="col-lg-12">
                <div class="blog-post">
                  ...
                  <div class="down-content">
                    <span>Lifestyle</span>
                    <a href="{{route('post_detail')}}"><h4>Aenean pulvinar gravida sem nec</h4></a>
                    <ul class="post-info">
                ...
                <div class="sidebar-item comments">
                  ...
                  <div class="content">
                    <ul>
                      ...
                      <li class="replied">
                        <div class="author-thumb">
                          <img src="{{asset('images/comment-author-02.jpg')}}" alt="">
                        </div>
                        <div class="right-content">
                      ...
                      <li>
                        <div class="author-thumb">
                          <img src="{{asset('images/comment-author-03.jpg')}}" alt="">
                        </div>
                        <div class="right-content">
